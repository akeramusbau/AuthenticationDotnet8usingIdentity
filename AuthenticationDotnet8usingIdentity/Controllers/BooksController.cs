...
namespace AuthenticationDotnet8usingIdentity.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BooksController : ControllerBase
    {
        private readonly AuthenticationDotnet8usingIdentityContext _context;

        public BooksController(AuthenticationDotnet8usingIdentityContext context)
        {
            _context = context;
        }
